<template>
    <div class="clock">
        ...
        <div class="c-footer">
            <a href="javascript:void(0)" class="c-button" @click='scanSignIn'>扫码签到</a>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        //执行签到
        doSign: function(codeStr, signType){
            var _this = this;
                ...
                success: function (res) {
                    ...
                    AMap.convertFrom(gps, 'gps', function (status, result) {
                        if (result.info === 'ok') {
                            ...
                            _this.getDosignApi(codeStr,signType,locations);//签到
                        }
                    });
                },
                cancel: function (res) {
        ...
        //签到接口
        getDosignApi(codeStr,signType,locations){
            // var params = {
            //     codeStr: "https://uc.doone.com.cn/mp/?&clientId=XDW_SIGN_TEST&qrCodeKey=0F63D93B0144498A86416382A9C30385",
            //     signType: "1",  //1-正常考勤 2-公出 3-忘打卡 4-加班 5-请假 6-出差 9-其它
            //     locations: "119.268407,26.10879"
            // }
            var params;
            if(codeStr==''){
                params = {
